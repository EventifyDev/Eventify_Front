...
export const Navbar = () => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 border-b bg-slate-50 dark:bg-black border-gray-200/50 dark:border-gray-800/50">
            ...
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4">
                ...
                <div className="h-16 flex items-center justify-between">
                    <NavLink to="/" className="main-logo flex items-center shrink-0 group">
                        ...
                        {/* Logo Text */}
                        <div className="ml-3 relative font-nunito">
                            ...
                            {themeConfig.theme === 'light' ? (
                                <button
                                    className={`${themeConfig.theme === 'light' &&
                                        'flex items-center p-2 rounded-full bg-primary/5 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60'
                                        }`}
                                    onClick={() => {
                            ...
                            {themeConfig.theme === 'dark' && (
                                <button
                                    className={`${themeConfig.theme === 'dark' &&
                                        'flex items-center p-2 rounded-full bg-white/40 text-slate-50 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60'
                                        }`}
                                    onClick={() => {
                            ...
                            {themeConfig.theme === 'system' && (
                                <button
                                    className={`${themeConfig.theme === 'system' &&
                                        'flex items-center p-2 rounded-full bg-light/40 text-slate-50 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60'
                                        }`}
                                    onClick={() => {
