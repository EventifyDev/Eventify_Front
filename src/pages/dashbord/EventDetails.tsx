  ...
  return (
    <div className="mx-auto px-4 py-8">
      ...
      {event.rejectionReason && (
        <div className="mb-8">
          <div className="bg-gradient-to-r from-red-50 to-red-100/50 dark:from-red-900/20 dark:to-red-800/10 rounded-2xl p-6 border border-red-100 dark:border-red-800/30 shadow-lg">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-3 py-1 bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300 text-sm font-medium rounded-full">
                    Event Rejected
                  </span>
