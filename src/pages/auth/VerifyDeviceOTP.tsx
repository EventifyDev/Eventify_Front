...
import { verifyDevice, resendOtp, selectAuth } from '../../store/authSlice';
import { useFormik } from 'formik';
import * as Yup from 'yup';
import { toast } from 'sonner';
import LanguageSwitcher from '../../components/LanguageSwitcher';

const VerifyDeviceOTP = () => {
    ...
    // Références pour les inputs OTP
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
          ...
          try {
            await dispatch(verifyDevice({ email, otpCode })).unwrap();
            navigate('/events');
                    ...
                    <div className="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[38rem] py-20">
                        ...
                        <div className="mx-auto w-full max-w-[440px]">
                            <div className="mb-10 text-center">
                                <h1 className="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Verify New Device</h1>
                                <p className="mt-3 text-base font-medium leading-normal text-white-dark">We've sent a verification code to {email} to authorize this device</p>
                            </div>
                                ...
                                <div className="mt-6 text-center">
                                    ...
                                    <div className="mt-5 flex items-center justify-center space-x-1">
                                        ...
                                        {resendDisabled && !isExpired ? (
                                            <span className="text-sm font-semibold text-gray-400">Resend in {countdown}s</span>
                                        ) : (
                                            <button
                                                type="button"
